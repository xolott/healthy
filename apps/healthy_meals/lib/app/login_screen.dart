      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('Email and password login against the API is not implemented yet. Complete first-owner onboarding on a fresh server, or use a stored session from onboarding.'),
          ],
        ),
      ),
    );
